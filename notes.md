...
**我发现了有人写了一个更好的关于[椭圆曲线的解释](https://andrea.corbellini.name/2015/05/17/elliptic-curve-cryptography-a-gentle-introduction/)（英文警告）**
...
余因子(可选)：1（这个我是在标准中看到的,原因看[这里](https://www.zhihu.com/question/437176611)）  
...
密钥交换协议在标准文件第三章，是我的知识盲区（什么，公钥密码算法需要密钥交换？这不是用算法的程序需要办的事吗？）先写着非对称看看，如果不用就先放放。

### 非对称密码算法

#### 加密过程

长度为$klen$比特的消息$M$、公钥$$P_B
1. 生成随机数$k\in[1,n-1]$  
